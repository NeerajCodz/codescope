...
export function FilePreviewModal({ open, onOpenChange, file }: FilePreviewModalProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-4xl bg-[#0d1117] border-slate-800 text-white max-h-[90vh] flex flex-col p-0">
                <DialogHeader className="p-4 border-b border-slate-800 flex flex-row items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] text-slate-500 truncate max-w-sm">{file.path}</p>
                        </div>
                    </div>
                ...
                <ScrollArea className="flex-1 bg-black/20">
                    <pre className="p-6 font-mono text-[13px] leading-relaxed overflow-x-auto text-slate-300">
